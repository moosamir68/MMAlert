//
//  AnimationFromControllerToAlertAlertController.swift
//  Artiscovery
//
...
public class AnimationFromControllerToAlertAlertController: NSObject, UIViewControllerAnimatedTransitioning {
    ...
    public func animateTransition(using transitionContext: UIViewControllerContextTransitioning) {
        ...
        let toVC = transitionContext.viewController(forKey: .to) as! MMAlertAlertViewController
...
//MARK: - Dismiss Dialog
public class AnimationFromAlertAlertControllerToFromController: NSObject,UIViewControllerAnimatedTransitioning
{
    ...
    public func animateTransition(using transitionContext: UIViewControllerContextTransitioning) {
        ...
        let fromVC = transitionContext.viewController(forKey: .from) as! MMAlertAlertViewController
